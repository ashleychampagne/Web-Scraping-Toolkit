...
1. Open a browser to https://app.import.io/dash. Import.io has a variety of extractors that you can train. 
1. Create a new extractor and paste in one URL from your collection.
...
1. Save your extracter as a name you’ll recognize in the future.
1. Once you’ve saved your extractor, it should appear within the right hand side of your browser. 
1. Upload a list of URLs with similar content that you want to grab: 
1. Create a CSV or Excel XLSX file of URLs that you want to grab. 
1. Click the extractor you made based on one URL and click “settings” on the page.
1. Click “extract from an explicit list of URLs” and upload your CSV or Excel XLSX file of urls. 

1. Click “run URLs” to have the extractor crawl through every URL in the same way you originally trained it.
1. Download the data as a .xlsx file.
...
Finally, save or export the.docx Word file as a .txt file (e.g., save as “aggregate-plain-txt”) as follows: 
...
Finally, check the folder icon at the top of the Lexos page. Do you see your files? Download your files. You should now have a folder with individual plain text files of each document. 
